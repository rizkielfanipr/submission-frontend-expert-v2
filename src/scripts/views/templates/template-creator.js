...
const createRestaurantItemTemplate = (restaurant) => `
  <div class="restaurant-item">
    <div class="restaurant-item-header">
        <img loading="lazy" class="restaurant-item-header-poster" alt="${restaurant.name}"
...
const createRestaurantDetailTemplate = (restaurant) => `
  ...
  <img loading="lazy" class="restaurant-poster" src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}" crossorigin="anonymous" />
